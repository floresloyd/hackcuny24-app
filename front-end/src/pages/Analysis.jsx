...
import logoG from "../Public/Photos/logo-google.png";
        ...
        <div className="analysis-container">
            <div className="graph-container">
                ...
                <h2> This
                    ...
                    interconnected communities.</h2>
=======
                    <h1>The bar graph reveals a concerning rise in obesity across NYC boroughs, with Queens and Brooklyn standing out at almost 50% of its population facing weight-related issues.</h1>
                    <p>This alarming trend highlights the urgent need for intervention. However, a glimmer of hope emerges from other graphs showcasing diverse sports activities in popular parks. Beyond recreation, these activities build a healthier community. Engaging in sports not only combats obesity but also promotes cardiovascular health and community bonding. The key lies in fostering environments that encourage active living, turning parks into hubs for collective well-being. By embracing this approach, we not only tackle obesity but also nurture resilient, interconnected communities.</p>
                </div>
            </div>
            ...
            <div className="fixed-container">
                <a href="http://127.0.0.1:8080/fitness-report" className="fixed-link">
                    <img src={logoG} alt="Google Logo" className="fixed-logo" />
                    <span>Unlock Your Personalized Fitness Report: Sign In With Google Now!</span>
                </a>
            </div>
        </div>
    );
